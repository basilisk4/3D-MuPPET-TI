...
def segmentSam(image, predictor):
    ...
    # isolate biggest component of the mask
    ...
    if num_labels>2:
        ...
        mask_bw = (labels == largest_label).astype(np.uint8) * 255
    ...
    for i in tqdm(range(len(OutbboxList))):
        ...
        for x in range(len(SequenceObj.camObjects)):
            ...
            for box in boxesList:
                ...
                DLCPredict2D= DLCInference(Img,box,dlc_liveObj,CropSize,SamPredictor)
